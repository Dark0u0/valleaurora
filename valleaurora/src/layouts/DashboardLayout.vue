      ...
      <div class="max-w-7xl mx-auto flex flex-col gap-4">
        ...
        <div class="flex justify-between items-center border-b border-indigo-500/40 pb-3">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-2">
              <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Avatar" class="w-8 h-8 rounded-full border-2 border-indigo-400">
            </div>
          </div>
        </div>
